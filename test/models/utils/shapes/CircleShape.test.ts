...
import CircleShape from "../../../../src/models/utils/shapes/CircleShape";
...
describe("CircleShape", () => {
    ...
    it("is in", () => {
        ...
        const isInside = new CircleShape(magnitude).isInside(objectCoordinate, playerCoordinate, playerAngle);
