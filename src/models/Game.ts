...
export default class Game {
    ...
    addPlayer(id: string, window: Dimension, name: string) {
        const playerStartPos = new Coordinate(random(0, this.worldDimension.width), random(0, this.worldDimension.height));
        const player = new Player(id, window, name, playerStartPos);
